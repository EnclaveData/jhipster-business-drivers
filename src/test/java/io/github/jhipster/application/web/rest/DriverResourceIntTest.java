...
public class DriverResourceIntTest {
    ...
    private static final Rating DEFAULT_FIRST_RATING = Rating.Low;
    private static final Rating UPDATED_FIRST_RATING = Rating.Medium;

    private static final Rating DEFAULT_SECOND_RATING = Rating.Low;
    private static final Rating UPDATED_SECOND_RATING = Rating.Medium;
    ...
    public static Driver createEntity(EntityManager em) {
        Driver driver = new Driver()
            .name(DEFAULT_NAME)
            .firstRating(DEFAULT_FIRST_RATING)
            .secondRating(DEFAULT_SECOND_RATING);
        return driver;
    }
    ...
    public void createDriver() throws Exception {
        ...
        assertThat(testDriver.getFirstRating()).isEqualTo(DEFAULT_FIRST_RATING);
        assertThat(testDriver.getSecondRating()).isEqualTo(DEFAULT_SECOND_RATING);
    }
    ...
    public void getAllDrivers() throws Exception {
        ...
        restDriverMockMvc.perform(get("/api/drivers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].firstRating").value(hasItem(DEFAULT_FIRST_RATING.toString())))
            .andExpect(jsonPath("$.[*].secondRating").value(hasItem(DEFAULT_SECOND_RATING.toString())));
    }
    ...
    public void getDriver() throws Exception {
        ...
        restDriverMockMvc.perform(get("/api/drivers/{id}", driver.getId()))
            ...
            .andExpect(jsonPath("$.firstRating").value(DEFAULT_FIRST_RATING.toString()))
            .andExpect(jsonPath("$.secondRating").value(DEFAULT_SECOND_RATING.toString()));
    }
    ...
    public void updateDriver() throws Exception {
        ...
        updatedDriver
            .name(UPDATED_NAME)
            .firstRating(UPDATED_FIRST_RATING)
            .secondRating(UPDATED_SECOND_RATING);
        ...
        assertThat(testDriver.getFirstRating()).isEqualTo(UPDATED_FIRST_RATING);
        assertThat(testDriver.getSecondRating()).isEqualTo(UPDATED_SECOND_RATING);
    }
